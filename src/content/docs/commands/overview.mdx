...
If enabled, users will see this notice when they open a ticket and ticket creation will be blocked until the notice it is removed again. To enable this, you can either go to the [**<ins> Server Dashboard</ins>**](https://ticketon.app/dash) or use the **<ins> `/config out-of-office-notice`</ins>** command.
