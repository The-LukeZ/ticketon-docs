...
| Staff Roles                 | Array of role IDs that can manage tickets in this category.                   | None                     | -                                                         |
...
| Open Ticket Category        | The Discord category channel for open tickets.                                | null                     | -                                                         |
| Closed Ticket Category      | The Discord category channel for closed tickets.                              | null                     | -                                                         |
