...
| [Ticket Controls](#ticket-controls) | Configure which ticket controls should be available in tickets of this category. | Controls (Default)                    | -                                                         |
...
Wanna customize which ticket controls should be available in a category's tickets? No problem! You have 3 modes:

| Mode               | Description                                                                                                                                                                                                     |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Controls (Default) | You can choose from 7 ticket controls which will be available and present in the controls-message. Note that this needs at least **one** control enabled.                                                       |
| Custom Template    | You can provide your own custom message with components to use instead of the default one! This will then cause 2 messages to be sent **always**: The Starter Message and the Custom Template for the controls. |
| Off                | Turn everything off. This should be used if you either want no controls or already have the controls in your starter message.                                                                                   |
