...
### Importing Discord Messages

To import messages directly from Discord in the dashboard, go to to the Messages page,
and click the **Import** Button and change the tab in the dialog to **Discord Message**.
...
This should allow quicker setting up of your server with existing messages from a previous bot or configuration,
...
<ImageWrapper size="full">
  ![Form Custom ID in Starter Message Usage
  Example](../../../assets/docs/messages/customid_starter_message.png)
</ImageWrapper>
...
<Aside type="caution" icon="warning">
When a custom message is configured as a starter message, allowed mentions are
still used. All mentions, except for the support roles and the ticket author,
are disabled by default.

So if you're mentioning a role in your starter
message and wondering why it doesn't ping — that's probably why. Configure it
in the allowed mentions of your custom message and it'll work.
