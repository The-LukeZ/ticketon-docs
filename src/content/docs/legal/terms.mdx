...
Ticketon is a hosted Discord ticketing bot and related web dashboard provided by LukeZ Development - Inh. Luca Hentschel ("Ticketon", "we", "us", "our").
...
## Restrictions on your use of Ticketon
...
## Outages, Termination, General Service
...
## Usage of your brand's features
...
- Contact: For questions, brand-use opt-out requests, or support, contact us via the dashboard or Discord (https://ticketon.app/discord).
  When having an inquiry about billing, please always try to see if [Paddle](https://paddle.net) can resolve your issue, otherwise contact me at [billing@ticketon.app](mailto:billing@ticketon.app).
